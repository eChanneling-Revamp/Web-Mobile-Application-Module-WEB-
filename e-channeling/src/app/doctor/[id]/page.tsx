            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden bg-white/30 border border-white/35 shadow-lg flex items-center justify-center shrink-0">
                {selectedDoctor.profileImage ? (
                  ...
                  <div className="text-[11px] text-white/90">No Image</div>
                )}
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white/85 text-[11px] sm:text-xs mt-0.5">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-md p-6 sm:p-7">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                {selectedDoctor.description || "No description added."}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              {hospitals.length === 0 ? (
                <p className="text-sm text-gray-500">No hospitals assigned</p>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {hospitals.map((h, idx) => (
                    <div
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 sm:p-7 lg:sticky lg:top-6 h-fit">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <p className="text-[11px] text-gray-500 mt-3">Fee</p>
            ...
            <button
              onClick={() => router.push(`/booking/${selectedDoctor.id}`)}
              className="mt-5 h-11 w-full rounded-md bg-green-500 hover:bg-green-600 text-white text-sm font-semibold transition-colors"
              type="button"
            >
              Book Now
            </button>
